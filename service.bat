...
if not defined GITHUB_VERSION (
    echo Warning: failed to fetch the latest version. This warning does not affect the operation of zapret. Check your internet connection,
    timeout /T 9
    if "%1"=="soft" exit 
    goto menu
)
...
set "CHOICE="
set /p "CHOICE=Do you want to automatically download the new version? (THIS WILL DOWNLOAD ORIGINAL ZAPRET!!) (Y/N) (default: Y) "
